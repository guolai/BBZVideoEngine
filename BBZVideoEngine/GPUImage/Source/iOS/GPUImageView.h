...
typedef NS_ENUM(NSUInteger, BBZGPUFillModeType) {
    BBZGPUFillModeStretch,
    BBZGPUFillModePreserveAspectRatio,
    BBZGPUFillModePreserveAspectRatioAndFill
};


typedef NS_ENUM(NSUInteger, BBZGPURotationType) {
    BBZGPURotation0,
    BBZGPURotation90,
    BBZGPURotation180,
    BBZGPURotation270,
...
@property (nonatomic, assign) BBZGPURotationType rotationType;
